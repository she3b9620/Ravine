...
import { ChevronDown, UserRound, UserCog, Settings, Library, MessageCircle, Compass, Video, LogOut, ExternalLink } from "lucide-react";
...
export default function AccountMenu({locale,displayName,username,avatarUrl,isCreator}:Props){
 const ar=locale==="ar"; const rootRef=useRef<HTMLDivElement>(null); const [open,setOpen]=useState(false); const [closing,setClosing]=useState(false); const [signingOut,setSigningOut]=useState(false);
