...
const copy = {
  ar: {
    ...
    elite: "مساحات النخبة",
    generalBody: "المساحة الجامعة لرؤية ما يحدث داخل RAVINE والتعرف على الاتجاهات والنقاشات الرئيسية.",
    topicsBody: "مساحات مثل السينما، التصوير، المونتاج، الحركة، المؤثرات البصرية، الوثائقي، الموسيقى، البرامج الصوتية والألعاب.",
    creatorsBody: "لكل Creator مجتمع مستقل عن تعليقات الأعمال، مع إعدادات وصول وخصوصية قابلة للضبط.",
    ...
    loop: "العمل ← المجتمع ← الحوار ← Live ← Podcast ← العودة إلى المجتمع",
